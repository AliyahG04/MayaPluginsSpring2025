...
class ProxyRigger:
    ...
    def CreateProxyRigFromSelectionMesh(self):
        ...
        for jnt, verts in jntVertMap.items():
            print(f"jont {jnt} controls {verts} primarily")
...
class ProxyRiggerWidget(QMayaWindow):
    ...
    def GenerateProxyRigButtonClicked(self):
        self.proxyRigger.CreateProxyRigFromSelectionMesh()

    def GetWindowHash(self):
        return "55589f499c0ff6edeabe753e3ea1e04b6cdBe78d"
